...
export const COMMAND_TOOLS = [
  ...
  },
  {
    ...
    description:
      "Get the current Figma file key and name that was automatically detected from the running plugin. Returns null if no file is currently active.",
    inputSchema: toJsonSchema(GetCurrentFileSchema),
  },
];
